...
export function getModulen(obj) {
    return request({
        url: 'user-service/module/{"pageNo":"'+obj.pageNo+'","pageSize":"'+obj.pageSize+'"}/'+JSON.stringify(util.filterParams(obj)),
        method: 'get',
    })
}
...
export function putModulen(id,title,parentId,uri,icon,sort,menu,controls) {
    return request({
        ...
        method: 'put',
        data: {
            moduleInfo:JSON.stringify(util.filterParams({
                title,
                parentId,
                uri,
                icon,
...
export function addModulen(title,parentId,uri,icon,sort,menu,controls) {
    return request({
        url: 'user-service/module',
        method: 'post',
        data: {moduleInfo:JSON.stringify(util.filterParams({
                title,
                parentId,
                uri,
                icon,
