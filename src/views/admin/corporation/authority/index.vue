...
<script>
    import {getCorporationPermission,delCorporationPermission,addCorporationPermission} from "@/api/corporation";
    ...
    export default {
        ...
        methods: {
            getList () {
                ...
                getCorporationPermission(this.data).then(response => {
            ...
            deletes (row) {
                this.$confirm(
                    "此操作将永久删除该组织机构权限(权限名:" + row.name + "), 是否继续?",
                    "提示",
                    {
