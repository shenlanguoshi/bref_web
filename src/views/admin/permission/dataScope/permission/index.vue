...
<script>
    import {getDataScopePermission,delDataScopePermission,addDataScopePermission} from "@/api/dataScope";
    ...
    export default {
        ...
        methods: {
            getList () {
                ...
                getDataScopePermission(this.id).then(response => {
            ...
            create (data) {
                ...
                addDataScopePermission(this.id,data.id).then((response) => {
                    if(response.data.success){
                        this.getList();
            ...
            deletes (row) {
                this.$confirm(
                    ...
                    delDataScopePermission(this.id,row.id).then((response) => {
                        if(response.data.success){
                            this.getList();
