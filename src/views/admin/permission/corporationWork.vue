...
<script>
    ...
    import {getPermissionCorWork,delPermissionCorWork,addPermissionCorWork} from "@/api/permission";
    import waves from "@/directive/waves/index";
    export default {
        name: "permissionorporationWork",
        props: ['paramsid'],
        directives: {
            waves
        },
        ...
        methods: {
            ...
            deletes (row) {
                this.$confirm("此操作将永久删除该权限的岗位(岗位名:" + row.name + "), 是否继续?", '提示', {
