<template>
    <div>
        ...
        <el-dialog title="添加"
            ...
            <data-schema :msg="form" @deliverMsg="create"></data-schema>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    import {getPermissionDataSchema,delPermissionDataSchema,addPermissionDataSchema} from "@/api/permission";
    import waves from "@/directive/waves/index";
    export default {
        name: "permissionDataSchema",
        props: ['paramsid'],
        directives: {
            waves
        },
